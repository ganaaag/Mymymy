...
# API Configuration
API_ID = int(os.environ.get("API_ID", "25403301"))
API_HASH = os.environ.get("API_HASH", "d700b4abe3d023165894291b6fcbd3a0")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7977620356:AAFqKXQFKP8Dk3_JTNTwxIgX0HWynfRGbfo")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "1081310808"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "1081310808").split()]  # Default to owner ID
